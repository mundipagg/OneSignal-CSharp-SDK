...
namespace OneSignal.Resources.Notifications
{
    ...
    public class NotificationCreateOptions
    {
        ...
        /// <summary><br/>
        /// Targets notification recipients with filters. <br/>
        /// This is a array of JSON objects containing field conditions to check.<br/>
        /// </summary>
        [JsonProperty("filters")]
        public IList<INotificationFilter> Filters { get; set; }

        /// <summary><br/>
        /// Send based on OneSignal PlayerIds  <br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Sets the web push notification's icon. <br/>
        /// An image URL linking to a valid image. <br/>
        /// Common image types are supported; GIF will not animate. <br/>
        /// We recommend 256x256 (at least 80x80) to display well on high DPI devices. <br/>
        ...
        /// <summary><br/>
        /// Use a template you setup on our dashboard. You can override the template values by sending other parameters with the request.<br/>
        /// The template_id is the UUID found in the URL when viewing a template on our dashboard.<br/>
        /// Platforms: ALL<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Sending true wakes your app to run custom native code (Apple interprets this as content-available=1).<br/>
        /// Omit contents field to make notification silent.<br/>
        /// Platforms: iOS<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Sending true allows you to change the notification content in your app before it is displayed. <br/>
        /// Triggers didReceive(_:withContentHandler:) on your UNNotificationServiceExtension.<br/>
        /// Platforms: iOS 10+<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Adds media attachments to notifications. Set as JSON object, key as a media id of your choice and the value as a valid local file name or URL.<br/>
        /// User must press and hold on the notification to view.<br/>
        /// Do not set mutable_content to download attachments. The OneSignal SDK does this automatically.<br/>
        /// <code>Example: {"id1": "https://domain.com/image.jpg"}</code><br/>
        /// Platforms: iOS 10+<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Buttons to add to the notification. Icon only works for Android.<br/>
        /// <code>Example: [{"id": "id1", "text": "button1", "icon": "ic_menu_share"}, {"id": "id2", "text": "button2", "icon": "ic_menu_send"}]</code><br/>
        ...
        /// <summary><br/>
        /// Add action buttons to the notification. The id field is required.<br/>
        /// <code>Example: [{"id": "like-button", "text": "Like", "icon": "http://i.imgur.com/N8SN8ZS.png", "url": "https://yoursite.com"}, {"id": "read-more-button", "text": "Read more", "icon": "http://i.imgur.com/MIxJp1L.png", "url": "https://yoursite.com"}]</code><br/>
        ...
        /// <summary><br/>
        /// Category APS payload, use with registerUserNotificationSettings:categories in your Objective-C / Swift code.<br/>
        /// <code>Example: calendar category which contains actions like accept and decline</code><br/>
        /// iOS 10+ This will trigger your UNNotificationContentExtension whose ID matches this category.<br/>
        /// Platforms: iOS<br/>
        /// </summary>
        ...
        /// <code>Example: {"image": "https://domain.com/background_image.jpg", "headings_color": "FFFF0000", "contents_color": "FF00FF00"}</code><br/>
        /// Platforms: Android<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Specific Amazon icon to use. <br/>
        /// If blank the app icon is used. <br/>
        /// Must be the drawable resource name.<br/>
        /// Platforms: Amazon<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Specific Amazon icon to display to the left of the notification. <br/>
        /// If blank the adm_small_icon is used. <br/>
        /// Can be a drawable resource name or a URL.<br/>
        /// Platforms: Amazon<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// This flag is not used for web push For web push, please see chrome_web_icon instead.<br/>
        /// The local URL to an icon to use. If blank, the app icon will be used.<br/>
        ...
        /// <summary><br/>
        /// Sound file that is included in your app to play instead of the default device notification sound. <br/>
        /// Pass "nil" to disable vibration and sound for the notification.<br/>
        /// Platforms: iOS<br/>
        /// </summary>
        ...
        /// <code>Example: "notification"</code><br/>
        /// Platforms: Android<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Sound file that is included in your app to play instead of the default device notification sound.<br/>
        /// <code>Example: "notification.wav"</code><br/>
        ...
        /// <summary><br/>
        /// Sets the devices LED notification light if the device has one. ARGB Hex format.<br/>
        /// <code>Example(Blue): "FF0000FF"</code><br/>
        /// Platforms: Android<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Sets the background color of the notification circle to the left of the notification text. <br/>
        /// Only applies to apps targeting Android API level 21+ on Android 5.0+ devices.<br/>
        /// <code>Example(Red): "FFFF0000"</code><br/>
        /// Platforms: Android<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Sets the lock screen visibility for apps targeting Android API level 21+ running on Android 5.0+ devices.<br/>
        /// 1 = Public (default) (Shows the full message on the lock screen unless the user has disabled all notifications from showing on the lock screen. Please consider the user and mark private if the contents are.)<br/>
        /// 0 = Private (Hides message contents on lock screen if the user set "Hide sensitive notification content" in the system settings)<br/>
        ...
        /// <summary><br/>
        /// Describes whether to set or increase/decrease your app's iOS badge count by the ios_badgeCount specified count. Can specify None, SetTo, or Increase.<br/>
        /// None - leaves the count unaffected.<br/>
        /// SetTo - directly sets the badge count to the number specified in ios_badgeCount.<br/>
        /// Increase - adds the number specified in ios_badgeCount to the total. Use a negative number to decrease the badge count.<br/>
        /// Platforms: iOS<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Used with ios_badgeType, describes the value to set or amount to increase/decrease your app's iOS badge count by.<br/>
        /// You can use a negative number to decrease the badge count when used with an ios_badgeType of Increase.<br/>
        /// Platforms: iOS<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Only one notification with the same id will be shown on the device. Use the same id to update an existing notification instead of showing a new one.<br/>
        /// his is known as apns-collapse-id on iOS and collapse_key on Android.<br/>
        ...
        /// timezone (Deliver at a specific time-of-day in each users own timezone)<br/>
        /// last-active (Deliver at the same time of day as each user last used your app).<br/>
        /// If send_after is used, this takes effect after the send_after time has elapsed.<br/>
        /// Platforms: ALL<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Use with delayed_option=timezone.<br/>
        /// <code>Example: "9:00AM"</code><br/>
        /// Platforms: ALL<br/>
        /// </summary>
        ...
        /// The notification will be expired if the device does not come back online within this time.<br/>
        /// The default is 259,200 seconds (3 days).<br/>
        ...
        /// <summary><br/>
        /// Delivery priority through the push server (example GCM/FCM). <code>Pass 10 for high priority.</code><br/>
        /// Defaults to normal priority for Android and high for iOS.<br/>
        /// For Android 6.0+ devices setting priority to high will wake the device out of doze mode.<br/>
        /// Platforms: iOS, Android, Chrome, ChromeWeb<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Summary message to display when 2+ notifications are stacked together.<br/>
        /// Default is "# new messages". Include $[notif_count] in your message and it will be replaced with the current number. <br/>
        /// "en" (English) is required. <br/>
        /// The key of each hash is either a a 2 character language code or one of zh-Hans/zh-Hant for Simplified or Traditional Chinese. <br/>
        /// The value of each key is the message that will be sent to users for that language.<br/>
        /// <code>Example: {"en": "You have $[notif_count] new messages"}</code><br/>
        /// Platforms: Amazon<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Indicates whether to send to all devices registered under your app's Apple iOS platform.<br/>
        /// Platforms: iOS<br/>
        /// </summary>
        [JsonProperty("isIos")]
        ...
        /// <summary><br/>
        /// Indicates whether to send to all devices registered under your app's Google Android platform.<br/>
        /// Platforms: Android<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Indicates whether to send to all subscribed web browser users, including Chrome, Firefox, and Safari.<br/>
        /// You may use this instead as a combined flag instead of separately enabling isChromeWeb, isFirefox, and isSafari, though the three options are equivalent to this one.<br/>
        /// Platforms: WEB<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Indicates whether to send to all Google Chrome, Chrome on Android, and Mozilla Firefox users registered under your Chrome &amp; Firefox web push platform.<br/>
        /// Platforms: WEB<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Indicates whether to send to all Mozilla Firefox desktop users registered under your Firefox web push platform.<br/>
        /// Platforms: WEB<br/>
        /// </summary>
        ...
        /// <summary><br/>
        /// Indicates whether to send to all devices registered under your app's Windows Phone 8.0 platform.<br/>
        ...
        /// <summary><br/>
        /// Indicates whether to send to all devices registered under your app's Windows Phone 8.1+ platform.<br/>
        ...
        /// <summary><br/>
        /// Indicates whether to send to all devices registered under your app's Amazon Fire platform.<br/>
        /// Platforms: Amazon<br/>
        /// </summary>
        [JsonProperty("isAdm")]
        ...
        /// <summary><br/>
        /// This flag is not used for web push Please see isChromeWeb for sending to web push users. This flag only applies to Google Chrome Apps &amp; Extensions.<br/>
